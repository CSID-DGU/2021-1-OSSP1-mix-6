...
JUDGE_INPUT_PATH = INPUT_TEST_PATH + "judge_input.py"
...
DUPLICATE_PATH = "duplication/"
DUPLICATE_JUDGE_PATH = "duplication.py"
DUPLICATE_RESULT_PATH = "duplication_result.txt"
